        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
            <form id="registration-form" method="POST" action="{{ $authUrls['register_post'] }}">
                ...
                <div class="step-content hidden" id="step-content-2">
                    ...
                    {{-- <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                        <a href="{{ $authUrls['auth_google'] }}" class="social-btn flex items-center justify-center px-4 py-3 rounded-lg bg-white hover:bg-gray-50">
                        ...
                        <a href="{{ $authUrls['auth_facebook'] }}" class="social-btn flex items-center justify-center px-4 py-3 rounded-lg bg-white hover:bg-gray-50">
            ...
            <div class="text-center mt-8 pt-6 border-t border-gray-200">
                <p class="text-gray-600">
                    ...
                    <a href="{{ $authUrls['login'] }}" class="font-semibold hover:underline" style="color: var(--color-blue);">Sign in</a>
                </p>
            </div>
        </div>
    </div>
