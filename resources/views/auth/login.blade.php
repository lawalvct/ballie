    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="login-card rounded-2xl shadow-2xl p-8">
            ...
            <div class="space-y-4 mb-8">
                <a href="{{ $authUrls['auth_google'] }}" class="social-btn w-full flex items-center justify-center px-4 py-3 rounded-lg bg-white hover:bg-gray-50">
                ...
                <a href="{{ $authUrls['auth_facebook'] }}" class="social-btn w-full flex items-center justify-center px-4 py-3 rounded-lg bg-white hover:bg-gray-50">
            ...
            <form method="POST" action="{{ $authUrls['login_post'] }}" class="space-y-6">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if ($authUrls['password_request'] !== '#')
                        <a href="{{ $authUrls['password_request'] }}" class="text-sm hover:underline" style="color: var(--color-blue);">
                            Forgot password?
                        </a>
                    @endif
                </div>
            ...
            <div class="text-center mt-8 pt-6 border-t border-gray-200">
                <p class="text-gray-600">
                    ...
                    <a href="{{ $authUrls['register'] }}" class="font-semibold hover:underline" style="color: var(--color-blue);">
