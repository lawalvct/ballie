...
@section('page-description')
    <span class="hidden md:inline">Modify role details and permissions</span>
@endsection
...
@section('content')
    <div class="max-w-5xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <form method="POST" action="{{ route('tenant.admin.roles.update', [tenant('slug'), $role->id]) }}">
                @csrf
                @method('PUT')
                ...
                <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-8">
                    ...
                    <p class="text-purple-100 mt-2">Update role details and permissions</p>
                </div>
