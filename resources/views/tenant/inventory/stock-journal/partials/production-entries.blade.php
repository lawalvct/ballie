...
<div class="flex items-center justify-between mt-6">
    ...
    <div class="flex space-x-3">
        <button type="submit" name="action" value="save"
                class="inline-flex items-center px-6 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg shadow-sm hover:bg-gray-700">
        ...
        <button type="submit" name="action" value="save_and_post"
            class="inline-flex items-center px-6 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg shadow-sm hover:bg-blue-700">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
