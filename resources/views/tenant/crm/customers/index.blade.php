    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="text-sm font-medium text-gray-500 truncate">Total @term('customers')</dt>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="text-sm font-medium text-gray-500 truncate">Active @term('customers')</dt>
        ...
        <div class="p-6">
            ...
            <form method="GET" class="space-y-4">
                ...
                <div x-show="filtersExpanded"
                    ...
                    <div>
                        <label for="customer_type" class="block text-sm font-medium text-gray-700 mb-1">@term('customer') Type</label>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        Spent: ₦{{ number_format($customer->total_spent ?? 0, 2) }}
                                    </div>
                                    <div class="text-sm text-gray-500">
