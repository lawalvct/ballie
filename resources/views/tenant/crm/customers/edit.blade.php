...
@section('title') Edit @term('customer') @endsection
@section('page-title') Edit @term('customer') @endsection
@section('page-description') Update @term('customer') information and details @endsection
    ...
    <div class="bg-white rounded-2xl shadow-lg">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Edit @term('customer')</h2>
                    <p class="text-gray-600 mt-1">Update @term('customer') information and details</p>
                </div>
        ...
        <form id="customerForm" action="{{ route('tenant.crm.customers.update', ['tenant' => $tenant->slug, 'customer' => $customer->id]) }}" method="POST" class="p-6 space-y-8">
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900">@term('customer') Type</h3>
                        ...
                        <div class="p-4 border-2 border-gray-300 rounded-xl cursor-pointer peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:bg-gray-50 transition-all duration-200">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Personal @term('customer')</p>
                                </div>
                            </div>
                        </div>
                    </label>
