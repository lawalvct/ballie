...
<div class="space-y-6">
    <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div class="flex flex-col sm:flex-row sm:flex-wrap gap-2 xl:justify-end">
            <button type="button"
            ...
            <a href="{{ route('tenant.crm.vendors.export.template', ['tenant' => $tenant->slug]) }}"
               class="inline-flex w-full sm:w-auto justify-center items-center px-4 py-2 bg-white border border-gray-300 rounded-lg font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition ease-in-out duration-150">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="importModal" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
            <form action="{{ route('tenant.crm.vendors.import', ['tenant' => $tenant->slug]) }}" method="POST" enctype="multipart/form-data" id="importForm">
                @csrf
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">Upload Excel or CSV file to bulk import vendors</p>
                            </div>
                        </div>
                    ...
                    <!-- Instructions -->
                    <div class="mb-6">
                        <button type="button" onclick="document.getElementById('importInstructions').classList.toggle('hidden')" class="flex items-center text-sm font-medium text-purple-600 hover:text-purple-800">
                        ...
                        <div id="importInstructions" class="hidden mt-3 bg-purple-50 border-l-4 border-purple-400 p-4 rounded">
                            <div class="flex">
                                <div class="ml-3 flex-1">
                                    <h4 class="text-sm font-medium text-purple-800 mb-2">Import Instructions</h4>
                                    <div class="text-sm text-purple-700">
                                        <ul class="list-disc list-inside space-y-1">
                                            <li>Download the template file to see the required format</li>
                                            <li>Fill in your vendor data following the template structure</li>
                                            ...
                                            <li>Vendor type must be either <strong>individual</strong> or <strong>business</strong></li>
                    ...
                    <!-- Column Guide -->
                    <div class="mt-6">
                        <button type="button" onclick="document.getElementById('columnGuide').classList.toggle('hidden')" class="text-sm font-medium text-purple-600 hover:text-purple-800 flex items-center">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                                <div>
                                    ...
                                    <ul class="space-y-1 text-gray-600">
                                        <li><strong>vendor_type:</strong> individual or business</li>
                                        ...
                                        <li><strong>website:</strong> Optional website URL</li>
                                        <li><strong>tax_id:</strong> Tax identification number</li>
                                        <li><strong>registration_number:</strong> Business registration</li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="space-y-1 text-gray-600">
                                        ...
                                        <li><strong>payment_terms:</strong> Payment terms (e.g., Net 30)</li>
                                        <li><strong>bank_name:</strong> Vendor's bank name</li>
                                        <li><strong>bank_account_number:</strong> Account number</li>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="submit" id="submitBtn" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-purple-600 text-base font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:ml-3 sm:w-auto sm:text-sm">
