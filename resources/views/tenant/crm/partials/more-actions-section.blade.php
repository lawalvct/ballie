            ...
            <a href="#"
               class="action-card bg-gradient-to-br from-orange-600 to-orange-800 hover:from-orange-500 hover:to-orange-700 border border-orange-500 rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:scale-105 group">
                <div class="flex items-center mb-3">
                    ...
                    <div>
                        <h5 class="font-semibold text-white group-hover:text-orange-200 transition-colors duration-300">Payment History</h5>
                        <p class="text-xs text-orange-200">Transaction history</p>
                    </div>
                </div>
                <p class="text-xs text-orange-200">View complete payment transaction history.</p>
            </a>
        </div>
    </div>
