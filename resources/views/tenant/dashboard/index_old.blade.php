...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Total @term('sales')</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Total @term('purchase')</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-semibold text-gray-900">@term('sales') by Category</h3>
                <select class="px-3 py-1 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                    <option value="30" selected>Last 30 days</option>
                    <option value="90">Last 90 days</option>
                    <option value="365">Last year</option>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <!-- Top Products -->
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <h3 class="text-lg font-semibold mb-4">@term('top_products')</h3>
            <div class="space-y-4">
    ...
    <!-- Top Customers -->
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <h3 class="text-lg font-semibold mb-4">Top @term('customers')</h3>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <a href="{{ route('tenant.crm.customers.create', $tenant->slug) }}" class="p-4 border rounded-lg hover:bg-gray-50 text-center">
                ...
                <p class="text-xs font-medium">Add @term('customer')</p>
            </a>
            ...
            <a href="{{ route('tenant.inventory.products.create', $tenant->slug) }}" class="p-4 border rounded-lg hover:bg-gray-50 text-center">
                ...
                <p class="text-xs font-medium">Add @term('product')</p>
            </a>
            ...
            <a href="{{ route('tenant.reports.sales', $tenant->slug) }}" class="p-4 border rounded-lg hover:bg-gray-50 text-center">
                ...
                <p class="text-xs font-medium">@term('sales_reports')</p>
            </a>
