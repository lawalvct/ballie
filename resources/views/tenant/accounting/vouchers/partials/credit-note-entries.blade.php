{{-- Credit Note Entries Partial --}}
<div class="bg-white shadow-sm rounded-lg border border-gray-200" x-data="creditNoteEntries()">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="cn_customer_account"
                        ...
                        @foreach($ledgerAccounts->where('account_type', 'customer') as $account)
                ...
                <div>
                    <label for="cn_customer_amount" class="block text-sm font-medium text-gray-700 mb-1">
                        Credit Amount <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">₦</span>
                        <input type="number"
                               id="cn_customer_amount"
                               name="cn_customer_amount"
            ...
            <div x-show="customerAccountId" class="mt-3 p-3 bg-blue-100 rounded-md">
                ...
                <div class="flex justify-between items-center text-sm mt-1">
                    <span class="text-blue-700">After Credit Note:</span>
                ...
                <template x-for="(entry, index) in creditEntries" :key="index">
                    <div class="grid grid-cols-12 gap-3 items-end p-3 bg-white border border-green-200 rounded-md">
                        ...
                        <div class="col-span-5">
                            <label :for="'cn_account_' + index" class="block text-sm font-medium text-gray-700 mb-1">
                                Account <span class="text-red-500">*</span>
                            </label>
                            <select :id="'cn_account_' + index"
                        ...
                        <div class="col-span-4">
                            <label :for="'cn_description_' + index" class="block text-sm font-medium text-gray-700 mb-1">
                                Description
                            </label>
                            <input type="text"
                                   :id="'cn_description_' + index"
                        ...
                        <div class="col-span-2">
                            <label :for="'cn_amount_' + index" class="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div class="flex items-center justify-between pt-4 border-t border-gray-200">
            ...
            <div class="flex space-x-3">
                ...
                <button type="submit"
                    ...
                    <span x-show="!$store.loading">Save Credit Note</span>
                    <span x-show="$store.loading" class="flex items-center">
    ...
    return {
        ...
        updateCustomerAccount() {
            if (this.customerAccountId) {
                const selectEl = document.getElementById('cn_customer_account');
        ...
        updateEntryAccount(index) {
            ...
            if (entry.accountId) {
                const selectEl = document.getElementById(`cn_account_${index}`);
                const selectedOption = selectEl.options[selectEl.selectedIndex];
