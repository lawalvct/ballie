...
@section('page-title', 'Create ' . $term->label('quotation'))
@section('page-description', 'Create a new ' . strtolower($term->label('quotation')) . ' for your ' . strtolower($term->label('customer')))
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="document_title" id="document_title" required
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500">
                                <option value="QUOTATION" {{ old('document_title') == 'QUOTATION' ? 'selected' : '' }}>QUOTATION</option>
                                <option value="PROFORMA INVOICE" {{ old('document_title') == 'PROFORMA INVOICE' ? 'selected' : '' }}>PROFORMA INVOICE</option>
                                <option value="PROPOSAL" {{ old('document_title') == 'PROPOSAL' ? 'selected' : '' }}>PROPOSAL</option>
                                <option value="ESTIMATE" {{ old('document_title') == 'ESTIMATE' ? 'selected' : '' }}>ESTIMATE</option>
                                <option value="BID" {{ old('document_title') == 'BID' ? 'selected' : '' }}>BID</option>
                                <option value="OFFER" {{ old('document_title') == 'OFFER' ? 'selected' : '' }}>OFFER</option>
                            </select>
