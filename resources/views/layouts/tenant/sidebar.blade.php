    ...
    <div class="flex items-center justify-between h-20 px-6 border-b border-white border-opacity-10">
        <div class="flex items-center space-x-3 min-w-0 flex-1">
            ...
            <div class="sidebar-title min-w-0 flex-1 transition-opacity">
                <span class="text-xl font-bold bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent truncate block" title="{{ $tenant->name ?? 'Ballie' }}">
                   {{ $tenant->name ?? 'Ballie' }}
                </span>
                @if(isset($tenant))
        ...
        <ul class="space-y-2 px-4">
            ...
            <li>
                <a href="{{ route('tenant.inventory.index', ['tenant' => tenant()->slug]) }}"
                   ...
                   title="Inventory">
                    ...
                    <span class="menu-title whitespace-nowrap font-medium">@term('products')</span>
                </a>
            </li>
            @endpermission
            @endmodule
            ...
            <li>
                <a href="{{ route('tenant.crm.index', ['tenant' => tenant()->slug]) }}"
                   ...
                   title="@term('crm')">
                    ...
                    <span class="menu-title whitespace-nowrap font-medium">@term('crm')</span>
                </a>
            </li>
            @endpermission
            @endmodule
            ...
            <li>
                <a href="{{ route('tenant.projects.index', ['tenant' => tenant()->slug]) }}"
                   class="menu-item flex items-center px-4 py-3 rounded-xl group {{ request()->routeIs('tenant.projects.*') ? 'active' : '' }}"
                   title="Projects">
                    <div class="flex-shrink-0 w-6 h-6 mr-4 text-violet-400 group-hover:scale-110 transition-transform duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                        </svg>
                    </div>
                    <span class="menu-title whitespace-nowrap font-medium">Projects</span>
                </a>
            </li>
            @endpermission
            @endmodule
            ...
            <li>
                <a href="{{ route('tenant.statutory.index', ['tenant' => tenant()->slug]) }}"
                   ...
                   title="Statutory & Tax Management">
                    ...
                    <span class="menu-title whitespace-nowrap font-medium">@term('statutory')</span>
                </a>
            </li>
            @endpermission
            @endmodule
