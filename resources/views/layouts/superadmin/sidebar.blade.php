<nav class="flex-1 px-6 py-6 space-y-2 overflow-y-auto custom-scrollbar">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('super-admin.plans.index') }}"
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 {{ request()->routeIs('super-admin.plans.*') ? 'nav-item-active text-white shadow-lg' : 'text-gray-300 nav-item-hover hover:text-white' }}"
                       title="Plans & Pricing">
                        <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                        </svg>
                        <span class="menu-title whitespace-nowrap">Plans & Pricing</span>
                    </a>
                ...
                <div class="pt-6 mt-6 border-t border-white border-opacity-20">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('super-admin.system.settings') }}"
                           class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-300 {{ request()->routeIs('super-admin.system.settings*') ? 'nav-item-active text-white shadow-lg' : 'text-gray-300 nav-item-hover hover:text-white' }}"
