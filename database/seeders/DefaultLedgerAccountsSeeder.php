...
class DefaultLedgerAccountsSeeder extends Seeder
{
    public static function seedForTenant($tenantId)
    {
        ...
        // Only keep core accounts as system accounts (non-deletable)
        $systemAccountNames = [
            'Cash in Hand',
            'Accounts Receivable',
            'Accounts Payable',
        ...
        $defaultAccounts = array_map(function ($accountData) use ($systemAccountNames) {
            $accountData['is_system_account'] = in_array($accountData['name'], $systemAccountNames, true);
            return $accountData;
        }, $defaultAccounts);
